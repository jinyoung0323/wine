					...
					<div class="col">
						...
						<c:forEach items="${wineList}" var="winelist">
							<div class="card shadow-sm">
								...
								<a href="/wine/wineView?wine_no=${winelist.wine_no}"><img
		...
		<div class="text-center">
			<ul class="pagination">
				...
				<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}"
					var="idx">
					<li><a href="/wine/${pageMaker.makeQuery(idx)}&keyword=${keyword}&wine_type=${wine_type}&sort_type=${sort_type}">${idx}</a></li>
				</c:forEach>
