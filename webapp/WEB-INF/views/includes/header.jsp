   ...
   <div class="container">
      <header
         ...
         <ul
            ...
            <li><a href="/wine/cate?wine_type=레드" class="nav-link px-2 link-dark">red</a></li>
            <li><a href="/wine/cate?wine_type=화이트" class="nav-link px-2 link-dark">white</a></li>
            <li><a href="/wine/cate?wine_type=로제" class="nav-link px-2 link-dark">rose</a></li>
         </ul>
